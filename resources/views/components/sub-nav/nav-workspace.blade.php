<div class="btn-list d-flex justify-content-center">
    ...
    <span class="btn rounded-10 bg-dark-lt" onclick="custome_tab_page('#custome-tab-3')" role="button">{!! App\Models\GlobalModel::my_icon()->users !!} Member <sup class="ms-1 text-red">16</sup> </span>
    <span class="btn rounded-10 bg-dark-lt" role="button">{!! App\Models\GlobalModel::my_icon()->setting !!} Pengaturan</span>
</div>