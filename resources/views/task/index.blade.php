                            ...
                            <div class="mt-4">
                                <div class="row">
                                    <div class="col">
                                        <div class="avatar-list avatar-list-stacked">
                                            <span class="avatar avatar-xs avatar-rounded">HS</span>
                                            <span class="avatar avatar-xs avatar-rounded" style="background-image: url(./static/avatars/006m.jpg)"></span>
                                        </div>
                                    </div>
                                    <div class="col-auto text-muted">
                                        <button class="switch-icon switch-icon-scale" data-bs-toggle="switch-icon">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <div class="row">
                                    <div class="col">
                                        <div class="avatar-list avatar-list-stacked">
                                            <span class="avatar avatar-xs avatar-rounded" style="background-image: url(./static/avatars/004f.jpg)"></span>
                                        </div>
                                    </div>
                                    <div class="col-auto text-muted">
                                        <button class="switch-icon switch-icon-scale active" data-bs-toggle="switch-icon">
